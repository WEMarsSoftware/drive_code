...
// trying to set WiFi server to run on other core
TaskHandle_t Task1;
...
void setup()
{
  ...
  xTaskCreatePinnedToCore(
             &setupESPServer, /* Task function. */
             "ServerTask",   /* name of task. */
             10000,     /* Stack size of task */
             NULL,      /* parameter of the task */
             0,         /* priority of the task - set to 0 since this should override encoder interrupts */
